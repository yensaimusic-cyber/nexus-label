...
const MOCK_ARTISTS: Artist[] = [
  { id: 'a1', name: 'Luna Solaris', stage_name: 'Solaris', status: 'active', projects_count: 5, avatar_url: 'https://picsum.photos/seed/solaris/400' },
  { id: 'a2', name: 'Marcus Chen', stage_name: 'Ghost Tape', status: 'active', projects_count: 3, avatar_url: 'https://picsum.photos/seed/ghost/400' },
  { id: 'a3', name: 'Elena Rodriguez', stage_name: 'Neon Queen', status: 'on_hold', projects_count: 1, avatar_url: 'https://picsum.photos/seed/queen/400' },
  { id: 'a4', name: 'David Smith', stage_name: 'The Void', status: 'active', projects_count: 2, avatar_url: 'https://picsum.photos/seed/void/400' },
  { id: 'a5', name: 'Sarah Jenkins', stage_name: 'Lumina', status: 'archived', projects_count: 4, avatar_url: 'https://picsum.photos/seed/lumina/400' },
  { id: 'a6', name: 'Aris Thorne', stage_name: 'Pulse', status: 'active', projects_count: 0, avatar_url: 'https://picsum.photos/seed/pulse/400' },
];
