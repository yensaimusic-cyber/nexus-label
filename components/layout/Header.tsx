  ...
  return (
    <header className="h-20 flex items-center justify-between px-4 lg:px-8 glass sticky top-0 z-40 border-b border-white/10">
      ...
      <div className="flex items-center gap-2 lg:gap-6">
        <button className="flex items-center justify-center lg:gap-2 nexus-gradient p-2.5 lg:px-4 lg:py-2 rounded-xl text-white text-sm font-bold shadow-lg shadow-purple-500/20 hover:scale-105 transition-transform active:scale-95">
          <Plus size={20} />
        ...
        <div className="flex items-center gap-3 pl-2 lg:pl-4 lg:border-l border-white/10">
          <div className="text-right hidden lg:block">
            ...
            <p className="text-[9px] text-nexus-cyan font-mono uppercase tracking-[0.2em] mt-1">Manager</p>
          </div>
